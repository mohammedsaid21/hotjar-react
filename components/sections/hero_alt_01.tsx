        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-tight">
              Personalize Sourcing<br/><span className="flex justify-center">+</span>Scale Outreach Videos<br/>
              = <span className="bg-gradient-to-r from-pink-500 to-violet-500 text-transparent bg-clip-text">Calendly</span> Bookings
            </h1>
            <p className="text-xl text-muted-foreground">
              <span className="text-secondary-foreground">Source</span> top candidates <span className="text-secondary-foreground">faster</span>. Create your clone and give us a script. We will make <span className="text-secondary-foreground">personalized</span> Loom using your script for every candidate in your csv/Calendly/Clay/LinkedIn in minutes.
            </p>
