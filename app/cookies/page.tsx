  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Cookies are small text files that are placed on your computer or mobile device when you visit a website. They are widely used to make websites work more efficiently and provide a better user experience.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">How we use cookies</h2>
        <p className="mb-4">At Loomli, we use cookies to:</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Most web browsers allow you to manage cookies through their settings preferences. However, if you limit the ability of websites to set cookies, you may worsen your overall user experience, as it will no longer be personalized to you.</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">If you have any questions about our cookie policy, please contact us at privacy@loom.li</p>
      </section>
    </div>
  );
}